...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        self.feature1 = self.layer1(x)
        self.feature2 = self.layer2(self.feature1)
        self.feature3 = self.layer3(self.feature2)
        self.feature4 = self.layer4(self.feature3)
                
        self.feature1_flatten = torch.flatten(self.avg1(self.feature1), 1)
